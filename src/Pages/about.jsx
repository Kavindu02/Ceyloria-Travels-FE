        ...
        <div className="relative h-full container mx-auto px-6 flex flex-col justify-center pb-10">
          <div className="max-w-4xl space-y-6 md:space-y-8">
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-2xl font-light leading-relaxed border-l-4 border-cyan-400 pl-6">
              SDK Travels is dedicated to unveiling the true beauty of Sri Lanka, creating unforgettable journeys one traveler at a time.
            </p>
          </div>
        </div>
      </div>
      ...
      <section className="py-24 bg-[#0f172a] relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-white mb-6">Why Choose <span className="text-cyan-400">SDK Travels?</span></h2>
